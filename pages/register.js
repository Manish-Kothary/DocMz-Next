	...
	render() {
		...
		const steps = [
			...
			},
			{
				...
				content:
					infoForm.userType === "doctor" ? (
						<RegisterUpload onSubmit={this.onUploadSubmit} />
					) : (
						""
					)
			},
			{
				...
				subTitle:
					"Consectetur aipisicing elit sed dotem eiusmod tempor incune utnaem labore etdolore maigna aliqua enim poskina",
				content:
					infoForm.userType === "doctor" ? (
						<div className="p-5 text-center">
							<Link href="/doctor/dashboard">
								<a className="btn btn-primary">Go to your Dashboard</a>
							</Link>
						</div>
					) : (
						""
