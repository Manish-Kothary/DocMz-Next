...
export const getDoctorByNpi = npi =>
	Axios.get(apiList.getDoctorByNpi + `/${npi}`);
...
export const doctorProfileUpdate = body =>
	Axios.post(apiList.doctorProfileUpdate, body);
export const saveTimeSlots = body => Axios.post(apiList.saveTimeSlots, body);

export const getAppointments = ({ limit, doctor, date }) =>
	Axios.post(apiList.getAppointments, { limit, doctor, date });
